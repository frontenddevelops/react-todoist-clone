...
describe('<AddTask />', () => {
    ...
    describe('Success', () => {
        ...
        it('renders the <AddTask /> project overlay when clickes using onClick', () => {
            const {queryByTestId} = render(<AddTask showAddTaskMain/>);
        ...
        it('renders the <AddTask /> project overlay when clickes using onKeyDown', () => {
            const {queryByTestId} = render(<AddTask showAddTaskMain/>);
        ...
        it('renders the <AddTask /> and adds a task with a task date of TODAY', () => {
            useSelectedProjectValue.mockImplementation(() => ({
                selectedProject: '1'
            }));
        ...
        it('renders the <AddTask /> and adds a task with a task date of TOMORROW', () => {
            useSelectedProjectValue.mockImplementation(() => ({
                selectedProject: '1'
            }));
        ...
        it('renders the <AddTask /> and adds a task with a task date of NEXT_7', () => {
            useSelectedProjectValue.mockImplementation(() => ({
                selectedProject: '1'
            }));
